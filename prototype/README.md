...
Run [[Live Runner Trial Packet]] with [[Runner Trial Source Matrix]] during the next real runner trial so checklist score, branch/log proof, verification output, decision gates, and handoff text are captured in one place.
